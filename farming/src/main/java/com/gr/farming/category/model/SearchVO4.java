...
public class SearchVO4 {
   ...
   /**
     ...
     * @param bean 검색조건
     */
    public void setSearchVO(SearchVO4 bean){
	...
	public String toString() {
		return "SearchVO4 [searchCondition=" + searchCondition + ", searchKeyword=" + searchKeyword + ", searchUseYn="
				...
				+ recordCountPerPage + ", categoryNo=" + categoryNo + "]";
	}
