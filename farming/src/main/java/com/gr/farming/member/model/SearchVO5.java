...
public class SearchVO5 {
   ...
   /**
     ...
     * @param bean 검색조건
     */
    public void setSearchVO(SearchVO5 bean){
	...
	public String toString() {
		return "SearchVO5 [searchCondition=" + searchCondition + ", searchKeyword=" + searchKeyword + ", searchUseYn="
				...
				+ recordCountPerPage + ", memberNo=" + memberNo + "]";
	}
