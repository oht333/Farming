      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5">
            ...
            <strong>${detail }</strong> 전문 업체를 찾고 계시나요?
            ...
            <p class="mb-5 mb-lg-0"> <a class="btn btn-primary" href="<c:url value='/request/requestWrite?categoryNo=${categoryNo}'/>">1분 견적서 작성하기</a></p>
          </div>
