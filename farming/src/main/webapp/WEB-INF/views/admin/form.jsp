...
<!-- Bootstrap Styles-->
    ...
    <link href="<c:url value='/resources/admin_css/select2.min.css'/>" rel="stylesheet" >
	<link href="<c:url value='/resources/admin_css/checkbox3.min.css'/>" rel="stylesheet" >
        <!-- Custom Styles-->
...
<body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<c:url value='/admin/form'/>" class="active-menu"><i class="fa fa-edit"></i> Forms </a>
                    </li>
	...
	<script src="<c:url value='/resources/admin_js/select2.full.min.js'/>"></script>
