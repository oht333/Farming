            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">전문가 삭제</h3>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">전문가 삭제</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
<form name="frmDelete" method="post" action="<c:url value='/admin/manage/dev_del'/>" style="margin-left: 23%; width: 80%;  height: 400px;">
<input type="hidden" name="expertNo" value="${param.expertNo}">
                        <%-- <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2">
                                    <div class="form-group">
                                        <span class="sp" style="font-weight: bold; font-size:large;">${param.expertNo }번 회원을 삭제하시겠습니까?</span>
                                    </div>
