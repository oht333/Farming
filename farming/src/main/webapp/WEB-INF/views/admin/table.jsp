...
<!-- Bootstrap Styles-->
    ...
    <link href="<c:url value='/resources/admin_css/font-awesome.css'/>" rel="stylesheet" />
     <!-- Morris Chart Styles-->
        ...
        <!-- Custom Styles-->
    <link href="<c:url value='/resources/admin_css/custom-styles.css'/>" rel="stylesheet" />
     <!-- Google Fonts-->
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
     <!-- TABLE STYLES-->
    <link href="<c:url value='/resources/admin_js/dataTables/dataTables.bootstrap.css'/>" rel="stylesheet" />
</head>
<body>
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="<c:url value='/admin/table'/>" class="active-menu"><i class="fa fa-table"></i> Responsive Tables</a>
                    </li>
                    <li>
    ...
    <script src="<c:url value='/resources/admin_js/jquery.metisMenu.js'/>"></script>
     <!-- DATA TABLE SCRIPTS -->
    <script src="<c:url value='/resources/admin_js/dataTables/jquery.dataTables.js'/>"></script>
    <script src="<c:url value='/resources/admin_js/dataTables/dataTables.bootstrap.js'/>"></script>
        <script>
