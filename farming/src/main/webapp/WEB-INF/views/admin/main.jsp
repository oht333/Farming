...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
    ...
    <!-- Morris Chart Styles-->
    <link href="<c:url value='/resources/admin_js/morris/morris-0.4.3.min.css'/>" rel="stylesheet">
    <!-- Custom Styles-->
    <link href="<c:url value='/resources/admin_css/custom-styles.css'/>" rel="stylesheet">
    <!-- Google Fonts-->
    <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' />
    <link rel="stylesheet" href="<c:url value='/resources/admin_js/Lightweight-Chart/cssCharts.css'/>"> 
...
<div id="wrapper">
		...
		<div id="sideNav" href="<c:url value=''/>">
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="<c:url value='/admin/main'/>"><i class="fa fa-dashboard"></i> Dashboard</a>
                    </li>
                    <li>
