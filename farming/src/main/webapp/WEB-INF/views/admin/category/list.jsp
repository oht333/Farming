                    ...
                    <div class="col-sm-12">
                        <div class="card">
							...
							<c:if test="${pagingInfo.firstPage>1 }">
								<a href
						="<c:url value='/admin/category/list?currentPage=${pagingInfo.firstPage-1}'/>">
							...
							<c:forEach var="i" begin="${pagingInfo.firstPage}" end="${pagingInfo.lastPage }">
								...
								<c:if test="${i!=pagingInfo.currentPage }">	
										<a href
						="<c:url value='/admin/category/list?currentPage=${i}'/>">
										[${i }]</a>			
								</c:if>
							</c:forEach>
							...
							<c:if test="${pagingInfo.lastPage < pagingInfo.totalPage }">	
									<a href
						="<c:url value='/admin/category/list?currentPage=${pagingInfo.lastPage+1}'/>">
