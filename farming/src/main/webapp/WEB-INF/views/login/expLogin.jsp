		...
		$(function(){
	  		...
	  		$('#forgot').click(function(){
	  			if($('#email').val().length<1){
  					...
  					var email=$('#email').val();
  	  				open('/farming/expert/forgotpwd?email='+email,'dup',
      ...
      <div class="row min-vh-100">
        <div class="col-md-8 col-lg-6 col-xl-5 d-flex align-items-center">
          <div class="w-100 py-5 px-md-5 px-xxl-6 position-relative">
            ...
            <form class="form-validate" method="post" action="<c:url value='/login/expLogin'/>">
              <div class="mb-4">
                <label class="form-label" for="email"> 이메일</label>
                <input class="form-control" name="email" id="email" type="email" placeholder="example@farming.com" value="${cookie.eCk_email.value }">
              </div>
              <div class="mb-4">
                <div class="row">
                  <div class="col">
              ...
              <hr class="my-4">
              <p class="text-center">
              <small class="text-muted text-center">아직 회원이 아니세요? <a href="<c:url value='/expert/agreement'/>">회원가입</a></small>
              </p>
            </form>
