        ...
        <div class="row">
          <div class="col-lg-8">                          
            <div class="text-content">
              ...
              파밍은 고객님의 빠르고 신속한 이용을 위해 <code>간편회원가입</code> 시스템을 도입하였습니다.<br>
              고객님의 본인명의와 이메일만으로 가입하고 원하는 IT전문가를 지금바로 찾아보세요.<br>
              해당 메인페이지의 전문가찾기 검색기능을 사용하시면 각 지역별 / 분야별 전문가를 한눈에 볼수있습니다.
              
              </blockquote>
              <h3>2. 파밍캐시 충전하기</h3>
              <blockquote class="blockquote blockquote-primary bg-gray-100 p-4">
              원하시는 분야의 전문가에게 견적 요청서를 보낼때에는 <code>파밍캐시</code>가 필요합니다.<br>
              또한 전문가에게 견적서 회신을 받은후 해당 사안을 진행하고 싶으시다면 파밍캐시 / 카드결제가 가능합니다.<br>
              ...
              <h3>3. 견적서 요청하기</h3>
              <blockquote class="blockquote blockquote-primary bg-gray-100 p-4">
              쉽고 빠르게 원하는 조건의 전문가를 찾아보세요!<br>
              고객은 도움이 필요한 IT 서비스에 대해 요청서를 작성합니다.<br>
              ...
              <h3>4. 전문가와 연락하기</h3>
              <blockquote class="blockquote blockquote-primary bg-gray-100 p-4">
              전문가의 견적서가 도착하면 채팅방이 자동으로 열립니다.<br>
              ...
              <blockquote class="blockquote blockquote-primary bg-gray-100 p-4">
              전문가에게 만족스러운 서비스를 받으셨다면 파밍 이용후기 게시판에 리뷰를 남겨주세요.<br>
              고객님이 남겨주신 한 마디가 전문가님에게는 큰 힘이 될 수 있습니다.<br>
              이용후기 리뷰는 전문가를 고용한 이력이 있는 고객만 작성할 수 있습니다.<br>
