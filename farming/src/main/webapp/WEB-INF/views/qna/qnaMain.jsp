  ...
  <div class="accordion-item">
    ...
    <div id="collapseOne" class="accordion-collapse collapse" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        ...
        <code>고객이 원하는 서비스를 선택하여 요청서를 작성하면</code> 48시간 내에 전문가가가 견적(견적금액과 프로필)을 보냅니다.<br>
        여러 명의 전문가 견적을 확인한 후 채팅방을 통해 상담을 받고, 나에게 딱 맞는 전문가를 선택하세요.<br><br>
        <strong>고수 이용안내</strong><br><br>
        고객이 직접 작성한 요청서를 전문가에게 보내드립니다.<br>
        받은 요청서 중에서 적합한 고객을 선택하여 <code>고객의 요구사항이 반영되도록 견적(견적금액과 프로필)을 보내세요.</code><br>
        채팅 혹은 안심번호 통화를 통해 고객과 빠르게 연락할 수 있습니다.<br>
        고객에게 견적을 보내고, 상담을 시작하기 위해서는 <code>파밍캐시</code>가 필요합니다.
      </div>
    </div>
  </div>
  <div class="accordion-item">
    ...
    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        ...
        고객과 전문가는 채팅이나 안심번호를 이용한 통화로 전문가와 상세 내용을 조율할 수 있습니다.<br><br>
        서비스를 진행하기로 협의했다면 파밍캐시 결제 혹은 직거래를 이용할 수 있습니다.<br><br>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      <div class="accordion-body">
         ...
         요청서를 작성하실 때는, <code>요청서의 모든 질문에 답변을 해야 합니다.</code><br><br>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        ...
        전문가와 고객은 채팅과 안심번호 통화를 통해 고용을 확정할 수 있습니다.<br><br>
  ...
  <div class="accordion-item">
    ...
    <div id="collapseNine" class="accordion-collapse collapse" aria-labelledby="headingNine" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        ...
        따라서 파밍 고객센터에서 전문가와 직접 통화할 수는 없습니다.<br><br>
        서비스에 대한 구체적인 내용은 파밍 채팅이나 안심번호를 이용한 통화로 전문가님께 직접 문의해 주세요.<br><br>
        그밖에 파밍 이용에 불편한 점이 있거나 문의 사항이 있다면 고객센터의 문을 두드려 주세요.
      </div>
    </div>
  </div>
  <div class="accordion-item">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingEle">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseEle" aria-expanded="false" aria-controls="collapseEle">
        <strong>Q.&nbsp; 고수에게 리뷰는 어떻게 남기나요 ?</strong>
      </button>
    </h2>
    <div id="collapseEle" class="accordion-collapse collapse" aria-labelledby="headingEle" data-bs-parent="#accordionExample">
      <div class="accordion-body">
        <br><h6>A.&nbsp; 고수에게 만족스러운 서비스를 받으셨다면 숨고 후기게시판에 리뷰를 남겨주세요.</h6><br>
        고객님이 남겨주신 한 마디가 고수님에게는 큰 힘이 될 수 있습니다.<br><br> 
        <code>고수 리뷰는 고수를 고용한 이력이 있는 고객만 작성할 수 있습니다.</code><br><br>
